...
(function(){
    ...
    function registerEventHandlers(){
        $("#btnShowLoginView").click(showLoginViewClicked);
        $("#btnShowRegisterView").click(showRegisterViewClicked);
        $("#btnLoginLogin").click(loginClicked);
        $("#btnLoginRegister").click(showRegisterViewClicked);
    ...
    function showRegisterViewClicked(){
        $("main>*").hide();
        $("#registerView").show();
    ...
    function addBookmarkError(error){
        showErrorMessage("Bookmark create failed.")
    }
